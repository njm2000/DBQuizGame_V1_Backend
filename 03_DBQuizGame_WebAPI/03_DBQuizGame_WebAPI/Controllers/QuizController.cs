...
namespace _03_DBQuizGame_WebAPI.Controllers
{
    ...
    public class QuizController : ControllerBase
    {
        ...
        public IEnumerable<Quiz> GetTerminated()
        {
            try
            {
        ...
        public IEnumerable<Quiz> ContainsName(string keyword)
        {
            try
            {
        ...
        public IEnumerable<Quiz> ContainsDescription(string keyword)
        {
            try
            {
        ...
        [HttpPost("GenerateRandomQuestion")]
        public GenerateRandomQuestionResponse GenerateRandomQuestion(GenerateRandomQuestionRequest request)
        {
            ...
            try
            {
                response = _service.GenerateRandomQuestion(request);
